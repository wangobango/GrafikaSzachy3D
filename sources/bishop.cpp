...
Bishop::Bishop(bool white,ShaderProgram *shaderProgram,GLuint tex0):Model(shaderProgram,tex0){
    if(white){
        color =1;
...
void Bishop::draw(glm::mat4 mP,glm::mat4 mV){
