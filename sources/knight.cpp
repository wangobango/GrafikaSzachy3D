...
Knight::Knight(bool white,ShaderProgram *shaderProgram,GLuint tex0):Model(shaderProgram,tex0){
    if(white){
        color =1;
...
void Knight::draw(glm::mat4 mP,glm::mat4 mV){
